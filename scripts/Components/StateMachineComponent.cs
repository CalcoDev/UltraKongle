...
using Godot;
using KongleJam.Components.Coroutines;
...
public partial class StateMachineComponent : Node
{
    ...
    public void Physics()
    {
        if (_physics[_state] != null)
            _physics[_state].Invoke();
    }

    public void SetCallbacks(
        int index,
        Func<int> update, Action physics,
        Action enter = null, Action exit = null,
